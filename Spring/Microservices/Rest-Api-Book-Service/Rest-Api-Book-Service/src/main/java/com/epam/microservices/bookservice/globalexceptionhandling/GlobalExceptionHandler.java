package com.epam.microservices.bookservice.globalexceptionhandling;
...
public class GlobalExceptionHandler {
    ...
    public  ResponseEntity<ApiErrorResponse> handleQuizManagementException(WebRequest request, BookManagementException e) {
        ApiErrorResponse apiErrorResponse = new ApiErrorResponse();
        apiErrorResponse.setStatus(HttpStatus.NOT_FOUND.value());
        apiErrorResponse.setMessage(e.getMessage());
        apiErrorResponse.setTimeStamp(System.currentTimeMillis());
