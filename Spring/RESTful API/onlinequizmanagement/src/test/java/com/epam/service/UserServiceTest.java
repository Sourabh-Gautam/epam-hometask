...
public class UserServiceTest {
	...
	@Test
	void registerUserServiceTest() throws ResourceNotFoundException {
	...
	void getUserByUsernameTest() {
		...
		Optional<User> userdb = userService.getUserByUsername("epam");
		assertEquals("epam", userdb.get().getUsername());
	}
}
