...
@Component
public class QuestionOperation implements ApplicationContextAware {
	...
	private ResponseData<String, List<Question>> fetch(RequestData<String, String> requestData) {
		...
		Response<String, List<Question>> response = request.send(requestData, applicationContext.getBean(QuestionService.class));
