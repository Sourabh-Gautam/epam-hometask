...
//	Quiz Section
	...
	public ResponseEntity<QuizDto> createQuiz(@RequestBody QuizDto quizDto) throws EmptyFieldException, NoSuchFieldException {
	...
	public ResponseEntity<QuizDto> showQuiz(@PathVariable(name = "quizid") int quizId) throws ResourceNotFoundException {
	...
	public ResponseEntity<QuizDto> deleteQuiz(@PathVariable(name = "quizid") int quizId) throws ResourceNotFoundException {
	...
	public ResponseEntity<Object> renameQuiz(@RequestBody QuizDto quizDto) throws ResourceNotFoundException {
		ModelMapper modelMapper = new ModelMapper();
		Quiz quiz = quizService.getQuizById(quizDto.getId()).orElseThrow(
				() -> new ResourceNotFoundException("Quiz not found with id "+quizDto.getId()));
...
//	Question Section
	...
	public ResponseEntity<QuestionDto> deleteQuestion(@PathVariable(name = "questionid") int questionId) throws ResourceNotFoundException {
		
		ModelMapper modelMapper = new ModelMapper();
		Question question = questionService.findQuestionById(questionId).orElseThrow(
				()-> new ResourceNotFoundException("Question not found with the id "+questionId));
	...
	public ResponseEntity<QuestionDto> addQuestion(@RequestBody QuestionDto questionDto) throws EmptyFieldException, NoSuchFieldException {
		...
		Question question = Question.builder()
				.questionStatement(questionDto.getQuestionStatement())
